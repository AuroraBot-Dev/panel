...
import { NAlert, NButton, NCard, NDataTable, NSwitch, NTag } from 'naive-ui';
...
<template>
  <Page
    :description="$t('page.aurora.features.apps.description')"
    :title="$t('page.aurora.features.apps.title')"
  >
    <template #extra>
